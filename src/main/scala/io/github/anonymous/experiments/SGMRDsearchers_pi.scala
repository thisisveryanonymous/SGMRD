...
/**
  ...
  */
object SGMRDsearchers_pi extends Experiment with SubspaceSearchTerminology {
  val nRep = 1
  ...
  def run(): Unit = {
    ...
    for {
      ...
      val outliersearchers: ParVector[DataRef => SGMRD] = ParVector(
        ...
        //SGMRD(_, ks, 0.9, SelectRandom(1), windowsize, 10, parallelize=0, monitoring = true),
        //SGMRD(_, ks, 0.9, SelectRandom(2), windowsize, stepsize, parallelize=0, monitoring = true),
        ...
        //SGMRD(_, ks, 0.9, SelectWorst(1), windowsize, 10, parallelize=0, monitoring = true),
        //SGMRD(_, ks, 0.9, SelectWorst(2), windowsize, stepsize, parallelize=0, monitoring = true),
