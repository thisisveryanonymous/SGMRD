...
/**
  ...
  */
object SGMRDsearchers_scaling extends Experiment with SubspaceSearchTerminology {
  val nRep = 1
  ...
  def run(): Unit = {
    ...
    for {
      ...
      val outliersearchers: ParVector[DataRef => SGMRD] = ParVector(
        ...
        //SGMRD(_, ks, 0.9, SelectAll(), windowsize, 100, parallelize=0, monitoring=true), // naive adaptation
        SGMRD(_, ks, 0.9, SelectAll(), windowsize, 1000, parallelize = 0, monitoring = true), // naive adaptation
        SGMRD(_, ks, 0.9, SelectNone(), windowsize, stepsize, parallelize = 0, monitoring = true), // worst case

        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.2), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.3), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.4), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.5), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.6), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.7), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.8), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTS(0.0, 0.9), windowsize, stepsize, parallelize = 0, monitoring = true),

        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.1, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.2, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.3, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.4, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.5, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.6, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.7, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.8, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectSTSADWIN(0.0, 0.9, 0.1), windowsize, stepsize, parallelize = 0, monitoring = true),
      )
