...
import io.github.anonymous.streamminers.{HashMiner, LOFMiner, StreamMiner}
import io.github.anonymous.utils

/**
  * Created by anonymous
  */
object SGMRDminers extends Experiment {
  val nRep = 1
  val data: Vector[DataRef] = Vector(activity, kddcup99, example_10, example_20, example_50)

  val baserep: String = currentdir + "/data/subspaces"
  val subspacepaths: Map[DataRef, Array[String]] = Map(activity -> Array(
    baserep + "/activity-SGMRD-KSP-0.9-None-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/activity-SGMRD-KSP-0.9-RD-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/activity-SGMRD-KSP-0.9-Worst-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/activity-SGMRD-KSP-0.9-MPTS-1-0.0-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/activity-SGMRD-KSP-0.9-All-1000-1000-0-1-1-subspaces-0.txt",
  ), kddcup99 -> Array(
    baserep + "/kdd99-SGMRD-KSP-0.9-None-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/kdd99-SGMRD-KSP-0.9-RD-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/kdd99-SGMRD-KSP-0.9-Worst-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/kdd99-SGMRD-KSP-0.9-MPTS-1-0.0-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/kdd99-SGMRD-KSP-0.9-All-1000-1000-0-1-1-subspaces-0.txt",
  ), example_10 -> Array(
    baserep + "/example_10-SGMRD-KSP-0.9-None-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_10-SGMRD-KSP-0.9-RD-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_10-SGMRD-KSP-0.9-Worst-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_10-SGMRD-KSP-0.9-MPTS-1-0.0-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_10-SGMRD-KSP-0.9-All-1000-1000-0-1-1-subspaces-0.txt",
  ), example_20 -> Array(
    baserep + "/example_20-SGMRD-KSP-0.9-None-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_20-SGMRD-KSP-0.9-RD-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_20-SGMRD-KSP-0.9-Worst-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_20-SGMRD-KSP-0.9-MPTS-1-0.0-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_20-SGMRD-KSP-0.9-All-1000-1000-0-1-1-subspaces-0.txt",
  ), example_50 -> Array(
    baserep + "/example_50-SGMRD-KSP-0.9-None-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_50-SGMRD-KSP-0.9-RD-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_50-SGMRD-KSP-0.9-Worst-1-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_50-SGMRD-KSP-0.9-MPTS-1-0.0-1000-1-0-1-1-subspaces-0.txt",
    baserep + "/example_50-SGMRD-KSP-0.9-All-1000-1000-0-1-1-subspaces-0.txt",
  ))
