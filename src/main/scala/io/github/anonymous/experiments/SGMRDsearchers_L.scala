...
/**
  ...
  */
object SGMRDsearchers_L extends Experiment with SubspaceSearchTerminology {
  val nRep = 1
  ...
  def run(): Unit = {
    ...
    for {
      ...
      val outliersearchers: ParVector[DataRef => SGMRD] = ParVector(
        ...
        SGMRD(_, ks, 0.9, SelectRandom(2), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectRandom(5), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectRandom(10), windowsize, 10, parallelize = 0, monitoring = true),

        SGMRD(_, ks, 0.9, SelectWorst(1), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectWorst(2), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectWorst(5), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectWorst(10), windowsize, 10, parallelize = 0, monitoring = true),
        ...
        SGMRD(_, ks, 0.9, SelectMPTS(2, 0.0), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectMPTS(5, 0.0), windowsize, 10, parallelize = 0, monitoring = true),
        SGMRD(_, ks, 0.9, SelectMPTS(10, 0.0), windowsize, 10, parallelize = 0, monitoring = true),
      )
